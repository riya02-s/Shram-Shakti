    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-gray-200">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-1">Escalated Society Disputes</h1>
          <p className="text-sm text-gray-600">
            Unresolved grievances escalated from primary cooperative societies for federation arbitration.
          </p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead className="bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-100">
              <tr>
                <th className="px-6 py-3.5">Dispute ID</th>
                ...
                <th className="px-6 py-3.5">Escalated Date</th>
                <th className="px-6 py-3.5">Status</th>
                <th className="px-6 py-3.5 text-right">Federation Action</th>
              </tr>
            </thead>
