    ...
    <div className="p-3 sm:p-6 max-w-7xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 pb-4 border-b border-gray-200">
        <div>
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mt-1 leading-tight">Predictive Demand Forecast</h1>
          <p className="text-xs sm:text-sm text-gray-500">
            Simulated service demand predictions to enable proactive workforce staging.
          </p>
        </div>
      ...
      <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead className="bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-100">
              <tr>
                <th className="px-4 sm:px-5 py-3">Day / Window</th>
                <th className="px-4 sm:px-5 py-3 text-center">Plumbing</th>
                <th className="px-4 sm:px-5 py-3 text-center hidden sm:table-cell">Electrical</th>
                <th className="px-4 sm:px-5 py-3 text-center">Cleaning</th>
                <th className="px-4 sm:px-5 py-3 text-center hidden sm:table-cell">Carpentry</th>
                <th className="px-4 sm:px-5 py-3 text-center">Total</th>
                <th className="px-4 sm:px-5 py-3 text-center">Confidence</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              {demandForecastData.map((row) => (
                ...
                >
                  <td className="px-4 sm:px-5 py-3 text-gray-900 flex items-center gap-2">
                    {row.timeSlot}
                  ...
                  <td className="px-4 sm:px-5 py-3 text-center text-gray-700">{row.plumbing}</td>
                  <td className="px-4 sm:px-5 py-3 text-center text-gray-700 hidden sm:table-cell">{row.electrical}</td>
                  <td className="px-4 sm:px-5 py-3 text-center text-gray-700">{row.cleaning}</td>
                  <td className="px-4 sm:px-5 py-3 text-center text-gray-700 hidden sm:table-cell">{row.carpentry}</td>
                  <td className="px-4 sm:px-5 py-3 text-center font-bold text-indigo-700">
                    {row.predictedTotal}
                  </td>
