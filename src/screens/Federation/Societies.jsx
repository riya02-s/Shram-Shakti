    ...
    <div className="p-3 sm:p-6 max-w-7xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 pb-4 border-b border-gray-200">
        <div>
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mt-1 leading-tight">Affiliated Primary Cooperatives</h1>
          <p className="text-xs sm:text-sm text-gray-500">
            Federation-level oversight of registered societies, workforce, and compliance.
          </p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead className="bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-100">
              <tr>
                <th className="px-4 sm:px-5 py-3">Society Name</th>
                <th className="px-4 sm:px-5 py-3">Location &amp; Zone</th>
                <th className="px-4 sm:px-5 py-3 text-center">Workers</th>
                <th className="px-4 sm:px-5 py-3 text-center">Bookings</th>
                <th className="px-4 sm:px-5 py-3">Status</th>
                <th className="px-4 sm:px-5 py-3 hidden md:table-cell">Lead Contact</th>
              </tr>
            </thead>
              ...
              {filteredSocieties.map((society) => (
                <tr key={society.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 sm:px-5 py-3">
                    <div className="font-semibold text-gray-900 text-sm">{society.name}</div>
                    <div className="text-xs text-gray-400 font-mono mt-0.5">{society.id}</div>
                  </td>
                  <td className="px-4 sm:px-5 py-3">
                    <div className="text-gray-900 font-medium text-sm">{society.location}</div>
                    <span className="inline-block mt-0.5 px-2 py-0.5 rounded-md text-[10px] font-medium bg-gray-100 text-gray-600">
                      {society.zone} Zone
                    </span>
                  </td>
                  ...
                  <td className="px-4 sm:px-5 py-3 text-center font-semibold text-gray-800">
                  ...
                  <td className="px-4 sm:px-5 py-3 text-xs font-mono text-gray-600 hidden md:table-cell">
                    {society.leadContact}
                  </td>
                </tr>
              ))}
